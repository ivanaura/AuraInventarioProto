...
insert into INV_PC values('XXX12345','modelo','marca','AIO','operativo','con cargador','11-1-2017','ok','ok','ok','ok','nok','ok','ok','cumple','no cumple','11-1-2017','no','n/a','O111');
insert into INV_PC values('XXX67890','modelo','marca','Notebook','operativo','con cargador','11-1-2017','ok','ok','ok','ok','ok','ok','nok','cumple','cumple','11-1-2017','si','Freddy Marquez','OF');